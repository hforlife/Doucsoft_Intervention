...
<head>
    ...
    <title>Doucsoft Intervention || Web</title>
    <!-- Favicon icon -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                      <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('checklist.index') }}"
                                aria-expanded="false"><i class="mdi mdi-check"></i><span
                                    class="hide-menu">CheckList</span></a>
                        </li>
                        <li class="sidebar-item">
