...
<head>
    ...
    <title>Listes Interventions || Interventions</title>
    <!-- Favicon icon -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                                    ...
                                    @foreach ($inter as $inters)
                                        <tbody class="customtable">
                                            <tr>
                                                <td>{{ $ide }}</td>
                                                <td>{{ $inters->name }}</td>
                                                <td>{{ $inters->intervention_type }}</td>
                                                <td>{{ $inters->factory }}</td>
                                                <td>{{ $inters->time }}</td>
                                               <td>{{ $inters->agent }}</td>
                                            </tr>
                                        </tbody>
                        ...
                        <a class="btn btn-primary" href="/add-inter">Ajouter Intervention</a>
