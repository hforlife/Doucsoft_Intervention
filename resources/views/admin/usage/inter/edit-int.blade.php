...
<head>
    ...
    <title>DoucSoft Intervention || Modifier Intervention</title>
    <!-- Favicon icon -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Modifier Intervetion</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <form id="example-form" action="/edit-inter/{{ $entry->id }}" method="post"
                            class="mt-5" novalidate="novalidate">
                            @csrf
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <textarea name="data[1][observation]" id="observation" class="form-control" placeholder="Observation"
                                                                cols="30" required>{{$entry->data}}</textarea>
                                                        </td>
                                                        <td>
                                                            <label class="customcheckbox mb-3" for="completed">
                                                                <input type="checkbox" name="data[1][completed]" value="{{$entry->data}}">
