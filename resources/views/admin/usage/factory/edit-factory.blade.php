...
<head>
    ...
    <title>Doucsoft Intervention || Modifier Entreprises</title>
    <!-- Favicon icon -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Modifier Entreprises</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- ============================================================== -->
                        <div class="card">
                            <form class="form-horizontal" action="/edit-factory/{{ $entrys->id }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="form-control" id="fname"
                                                placeholder="Nom de l'Entreprise" value="{{ $entrys->name }}">
                                        </div>
                                    </div>
                                    {{-- Forme Juridique --}}
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="description" placeholder="Faites une brève description">{{ $entrys->description }}</textarea>
                                        </div>
                                    </div>
                                    {{-- Adresse --}}
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="address" class="form-control" id="fname"
                                                placeholder="Bamako, Mali" value="{{ $entrys->address }}">
                                        </div>
                                    </div>
                                    {{-- N°Tel --}}
                                    <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-3 text-end control-label col-form-label">N° Telephone</label>
                                        <div class="col-sm-9">
                                            <input type="tel" name="n°tel" class="form-control" id="fname"
                                                placeholder="00 00 00 00" value="{{ $entrys->n°tel }}">
                                        </div>
                                    </div>
                                    {{-- N°responsable --}}
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="tel" name="n°responsable" class="form-control"
                                                id="fname" placeholder="00 00 00 00"
                                                value="{{ $entrys->n°responsable }}">
                                        </div>
                                    </div>
                                </div>
                        </div>
