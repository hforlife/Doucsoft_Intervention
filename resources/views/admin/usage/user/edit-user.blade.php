...
<head>
    ...
    <title>Doucsoft Intervention || Modifier Admin</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <ul>
                        ...
                        <!-- ============================================================== -->
                        <div class="card">
                            <form class="form-horizontal" action="/edit-admin/{{ $admin->id }}" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="form-control" id="fname"
                                                placeholder="John Doe" value="{{ $admin->name }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" name="email" class="form-control" id="fname"
                                                placeholder="johndoe@example.com" value="{{ $admin->email }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
                                        ...
                                        <div class="col-sm-9">
                                            <input type="password" name="password" class="form-control"
                                                id="fname" placeholder="Password123"  >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
