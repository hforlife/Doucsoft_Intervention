...
<head>
    ...
    <title>Doucsoft Intervention || Ajouter Superviseur</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <div class="card">
                    <form class="form-horizontal" action="/add-sup" method="post" enctype="multipart/form-data">
                        @csrf
                      <div class="card-body">
